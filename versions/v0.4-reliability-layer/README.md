...
This version adds first-class Codex support.

New files:

```text
CODEX_RUNBOOK.md
meta-agent-os/00_control/TRIGGER_INDEX.md
...
meta-agent-os/00_control/codex/quick_commands.md
```

### Codex Full Run

From the project root in Codex, paste:
...
| Tool | Primary Instruction File | Trigger Style |
|---|---|---|
...
This version adds operational reliability on top of the v0.3 Codex-ready system.
...
meta-agent-os/00_control/modes/
meta-agent-os/07_examples/skeleton_full_run/
```

### Why This Matters

v0.3 was agent-readable.

v0.4 is more operationally robust because it adds:
...
- JSON state update protocol
- Skeleton examples

### Recommended Claude Code Trigger
...
The stage outputs should be comprehensive.

The state and validation layer should be machine-readable.
