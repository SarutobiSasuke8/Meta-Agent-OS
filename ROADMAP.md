...
### v0.5 — Commercial Refinement
- Open Core structure formalised
- First vertical pack: Consulting Delivery Pack
- Public documentation site
- Example run: game studio agent system (Cryptic Grove / Press Start Games)
- Community contribution guidelines

### v0.6 — Inference Economics Layer
- Token budget tooling integrated into QS stage
- Cost modelling templates per model (Opus, Sonnet, Haiku, GPT-4o, Gemini)
...
| Pack | Status |
|------|--------|
| Consulting Delivery Pack | Planned — v0.5 |
| Financial Services Pack | Planned — v0.6 |
| Healthcare & Life Sciences Pack | Planned — post v0.6 |
| Legal & Compliance Pack | Planned — post v0.6 |

---

## Not Planned

- Runtime execution engine (use LangGraph, CrewAI, or AutoGen for that)
