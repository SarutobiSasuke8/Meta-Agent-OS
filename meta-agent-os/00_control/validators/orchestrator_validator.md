...
Validate the Orchestrator output before advancing.
...
- [ ] Files created or updated are listed.
- [ ] Output is useful to the next stage.
- [ ] Output does not violate stage gates.
